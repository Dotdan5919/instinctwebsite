...
export default function GallerySection({ images }: GalleryProps) {
    ...
    <AnimatePresence>
      {lightboxIndex !== null && (
        ...
        >
          ...
          {/* Prev */}
          <button
            className="absolute left-4 top-1/2 -translate-y-1/2 w-11 h-11 rounded-full bg-white/15 hover:bg-white/30 flex items-center justify-center text-white transition-colors"
            style={{ zIndex: 10000 }}
          ...
          {/* Next */}
          <button
            className="absolute right-4 top-1/2 -translate-y-1/2 w-11 h-11 rounded-full bg-white/15 hover:bg-white/30 flex items-center justify-center text-white transition-colors"
            style={{ zIndex: 10000 }}
  ...
  return (
    <section className="bg-white py-12 sm:py-24">
      ...
      {/* Lightbox — portalled to document.body to escape stacking contexts */}
