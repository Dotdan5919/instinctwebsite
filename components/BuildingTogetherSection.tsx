      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-10 lg:px-14">
        ...
        <div className="flex flex-col gap-0 lg:hidden">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative w-full h-64 sm:h-80 overflow-hidden rounded-[28px]"
          >
            <Image
              src={heroBg}
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="rounded-[28px] bg-[#FDF3DC] p-8 sm:p-10 mt-6 shadow-[0_20px_50px_rgba(15,23,42,0.06)]"
          >
        ...
        <div className="relative hidden lg:block">
          ...
          >
            <h2 className="font-bebas text-5xl uppercase leading-[1.05] text-slate-950 xl:text-6xl">
              BUILDING TOMORROW,
              <br />
              TOGETHER
            </h2>
