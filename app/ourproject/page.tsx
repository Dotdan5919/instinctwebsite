...
export default function page() {
  ...
  <div className="mx-auto max-w-7xl h-full px-14 xl:px-24 relative">
    <div className="absolute inset-y-0 left-8 right-8 
          ...
          <div className={`flex w-screen overflow-hidden flex-col bg-[url('/images/project/hero.jpg')] bg-cover bg-no-repeat bg-center min-h-[50vh] sm:min-h-screen relative`}>
               <Preheader />
               
               <Navbar />
       
               <OtherHero title="Our Projects" subtitle={<>Defined expertise.<br /> Controlled delivery.</>} />
