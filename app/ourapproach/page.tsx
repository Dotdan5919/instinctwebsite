...
<div className={`flex w-screen overflow-hidden flex-col bg-[url('/images/ourapproach/ourapproach.jpg')] bg-cover bg-no-repeat bg-[75%_center] sm:bg-center min-h-[50vh] sm:min-h-screen relative`}>
      <Preheader />
